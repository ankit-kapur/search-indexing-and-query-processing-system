...
public class Token {
	...
	/**
	 * Method to set the termText to given text. This is a sample
	 * implementation and you CAN change this to suit your class
	 * definition and data structure needs.
	 * 
	 * @param text
	 */
	...
	/**
	 * Getter for termText This is a sample implementation and you CAN
	 * change this to suit your class definition and data structure needs.
	 * 
	...
	/**
	 * Method to merge this token with the given array of Tokens You are
	 * free to update termText and termBuffer as you please based upon
	 * your Token implementation. But the toString() method below must
	 * return whitespace separated value for all tokens combined Also the
	 * token order must be maintained.
	 * 
	 * @param tokens
